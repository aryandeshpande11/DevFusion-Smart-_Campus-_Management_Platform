...
// full list for the student dashboard: every assignment posted to a course
// matching their department/semester, with submission status merged in
export const getMyAssignments = () =>
    axiosClient.get("/assignments/mine").then((res) => res.data.assignments);
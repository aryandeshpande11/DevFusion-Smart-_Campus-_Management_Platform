...
export const createAssignment = (payload) =>
  axiosClient.post("/assignments", payload).then((res) => res.data);

export const getAssignmentsForCourse = (courseId) =>
  axiosClient.get(`/assignments/course/${courseId}`).then((res) => res.data);

export const getAssignmentById = (assignmentId) =>
  axiosClient.get(`/assignments/${assignmentId}`).then((res) => res.data);

export const updateAssignment = (assignmentId, changes) =>
  axiosClient.patch(`/assignments/${assignmentId}`, changes).then((res) => res.data);
...
export const getAssignmentSubmissions = (assignmentId) =>
  axiosClient.get(`/assignments/${assignmentId}/submissions`).then((res) => res.data);
...
export const getMySubmissions = () =>
  axiosClient.get("/assignments/me/submissions").then((res) => res.data);

...
export const getOverviewStats = () =>
  axiosClient.get("/analytics/overview").then((res) => res.data);

export const getAttendanceAnalytics = () =>
  axiosClient.get("/analytics/attendance").then((res) => res.data);

export const getPlacementAnalytics = () =>
  axiosClient.get("/analytics/placements").then((res) => res.data);

export const getEventAnalytics = () =>
  axiosClient.get("/analytics/events").then((res) => res.data);

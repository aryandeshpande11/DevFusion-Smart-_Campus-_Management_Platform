...
export const createAttendanceSession = (payload) =>
  axiosClient.post("/attendance/sessions", payload).then((res) => res.data.session);

export const getSessionsForCourse = (courseId) =>
  axiosClient.get(`/attendance/sessions/${courseId}`).then((res) => res.data.sessions);
...
export const getMyAttendanceHistory = () =>
  axiosClient.get("/attendance/me/history").then((res) => res.data.history);

export const getMyAttendanceSummary = () =>
  axiosClient.get("/attendance/me/summary").then((res) => res.data.summary);

export const getCourseAttendanceReport = (courseId) =>
  axiosClient.get(`/attendance/reports/${courseId}`).then((res) => res.data.report);

export const getMonthlyAttendanceReport = () =>
  axiosClient.get("/attendance/reports/monthly").then((res) => res.data.report);

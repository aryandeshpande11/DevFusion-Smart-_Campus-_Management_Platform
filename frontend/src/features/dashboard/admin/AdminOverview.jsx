        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          <Card>
            ...
            <div className="mt-5 flex justify-center">
              <DonutChart
                  segments={[
                    { label: "Present", value: attendancePercentage, color: "#2563EB" },
                    { label: "Absent", value: Math.max(0, 100 - attendancePercentage), color: "#ECEDF1" },
                  ]}
          ...
          <Card>
            ...
            <div className="mt-5 flex justify-center">
              <DonutChart
                  segments={[
                    { label: "On time", value: assignmentCompletionRate, color: "#FDBA4C" },
                    { label: "Late / missing", value: Math.max(0, 100 - assignmentCompletionRate), color: "#ECEDF1" },
                  ]}
